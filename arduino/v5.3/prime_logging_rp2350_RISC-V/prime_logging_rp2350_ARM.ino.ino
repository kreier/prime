/* Prime numbers in Arduino C v5.4 2026/05/11 for WaveShare RP2350 */
#include <time.h>
#include <math.h>
#include <EEPROM.h>
...
void setup() {
  ...
  Serial.print("\nGet previous results for this rp2350:\n");
  ...
  for (int i = 0; i < 8; i++) // 8
  {
    ...
    Serial.println("\n\nPrime v5.4 in Arduino C - 2026/05/11");
