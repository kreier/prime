# prime v5.3 2026-03-20 for ESP32-C3 SuperMini with makergo_esp32c3_supermini ESP32-C3N4
...
led = digitalio.DigitalInOut(board.LED) # IO4
...
if __name__ == "__main__":
    ...
    try:
        with open("/data/summary.txt", "w") as fp:
            fp.write(f'Primes calculation in Circuitpython v5.3 2026/03/20\n')
            fp.write(board.board_id)
