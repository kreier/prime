// prime to 2E32 version 5.6.2026 uint32 from 2026/02/06
...
int main()
{
    ...
    for (int i = 0; i < 11; i++)
    {
        ...
        printf("Calculating prime numbers in C v5.6.2026 until %u \n", last);
        // start = clock();
        ...
        fprintf(logfile, "Calculating prime numbers until %u in C v5.6.2026\n", last);
