// prime to 2^32 version 5.5.2025 int32 from 2025/04/26
...
int main()
{
    uint32_t last = 4294967295; // 4294967295
    clock_t start, end;
    double cpu_time_used;
    printf("Calculating prime numbers in C until %u with algorithm v5.5.2025\n", last);
    start = clock();
