// prime to 2E32 verson 5.4.2024 from 2023/12/16
...
uint32_t primes[6550] = {3, 5, 7};    // to store the 6542 primes to sqr(2E32)
...
void find_primes(uint32_t limit) {
...
int main()
{
    ...
    printf("Found %u primes until %u to use as divisors.\n", found, largest_divider);
