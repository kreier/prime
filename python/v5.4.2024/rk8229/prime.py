# prime v5.4.2025 with primes as a divider list up to 4294967295 = 2E32 - 1
...
if __name__ == "__main__":
    last  = 1000000        # 4294967295 is the limit for unsigned 32bit
    found = 4              # we start from 11, know 2, 3, 5, 7
    primes = [3, 5, 7]     # exclude 2 since we only test odd numbers
    print(f"Calculating prime numbers to {last} in Python with algorithm v5.4.2025")
